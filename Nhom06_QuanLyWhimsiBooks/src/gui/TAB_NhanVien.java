...
public class TAB_NhanVien extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cboChucVu.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Sales Rep", "Manager" }));
        ...
        cboGioiTinh1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Male", "Female" }));

        jLabel16.setText("Nhân viên");

        cboChucVu1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Sales Rep", "Manager" }));
...
//	chức năng tìm kiếmmm
	...
	private void btnTimKiemActionPerformed(java.awt.event.ActionEvent evt) {
		...
		// Hiển thị kết quả trên bảng hoặc làm gì đó với kết quả
		// ...
		...
		if (resultList != null) {
			...
			for (NhanVien nhanVien : resultList) {
				Object[] row = { nhanVien.getNhanVienID(), nhanVien.getUserName(), nhanVien.getPassword(),
						nhanVien.getNgayTaoTK(), nhanVien.getHoTen(), nhanVien.getGioiTinh(), nhanVien.getSoDienThoai(),
						nhanVien.getChucVu(), nhanVien.getEmail(), nhanVien.getNgaySinh(), nhanVien.getDiaChi() };
	...
	private void displaySearchResult(ArrayList<NhanVien> ketQuaTimKiem) {
		DefaultTableModel model = (DefaultTableModel) tblNhanVien.getModel();
		model.setRowCount(0); // Xóa dữ liệu cũ trong bảng

		for (int i = 0; i < ketQuaTimKiem.size(); i++) {
			NhanVien nv = ketQuaTimKiem.get(i);
			model.addRow(new Object[] { nv.getNhanVienID(), nv.getHoTen(), nv.getGioiTinh(), nv.getSoDienThoai(),
...
//kết thức tìm kiếm
	...
	private void btnSuaActionPerformed(java.awt.event.ActionEvent evt) throws Exception {
		...
		if (confirm == JOptionPane.YES_OPTION) {
			...
			NhanVien nhanVien = new NhanVien(maNhanVien, userName, password, ngayTaoTK1, hoTen, gioiTinh, soDienThoai,
					chucVu, email, ngaySinh, diaChi);
			ConnectDB.connect();
