...
public class TAB_KhachHang extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cboLoaiKH.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "VIP", "Regular" }));
        ...
        cboLoaiKH1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "VIP", "Regular", " " }));
                    ...
                    .addGroup(rightLayout.createSequentialGroup()
                        ...
                        .addGroup(rightLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(rightLayout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(cboLoaiKH1, javax.swing.GroupLayout.PREFERRED_SIZE, 59, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void loadKhachHangTable() {
    	...
    	for (int i = 0; i < listKH.size(); i++) {
			...
			model.addRow(new Object[] { i + 1, kh.getKhachHangID(), kh.getHoTen(), kh.getSoDienThoai(), kh.getNgaySinh(),kh.getEmail(),kh.getGioiTinh(),kh.getDiaChi(),kh.getMaSoThue(),kh.getLoaiKhachHang() });
		}
    }
	...
	private void btnThemKHActionPerformed(java.awt.event.ActionEvent evt) {                                          
	    	try {
				...
				KhachHang newKhachHang =new KhachHang(maKH, tenKH, sdtKH, LocalDate.parse(ngaySinh), gioiTinh, email, maSoThue, diaChi, loaiKH);
			KhachHang_BUS khachHangBus = new KhachHang_BUS();
